...
function setup() {
    ...
    let loadOption_idle = {
        model: 'models/443-2/idle/model.json',
        metadata: 'models/443-2/idle/model_meta.json',
        weights: 'models/443-2/idle/model.weights.bin',
    };
    let loadOption_scroll = {
        model: 'models/443-2/scroll/model.json',
        metadata: 'models/443-2/scroll/model_meta.json',
        weights: 'models/443-2/scroll/model.weights.bin',
    };
    let loadOption_zoom = {
        model: 'models/443-2/zoom/model.json',
        metadata: 'models/443-2/zoom/model_meta.json',
        weights: 'models/443-2/zoom/model.weights.bin',
    };
    // let loadOption_num = {
